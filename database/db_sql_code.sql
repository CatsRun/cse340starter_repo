...
ALTER TYPE public.account_type OWNER TO murray5340;
...
CREATE TABLE IF NOT EXISTS public.inventory (
    ...
    inv_thumbnail charactervarying NOT NULL,
...
-- Create relationship between 'clasification' and 'inventory' tables
...
-- final project: add review table
CREATE TABLE IF NOT EXISTS public.review (
    ...
    CONSTRAINT inv_id FOREIGN KEY (inv_id) REFERENCES public.inventory (inv_id) MATCH SIMPLE ON UPDATE CASCADE ON DELETE NO ACTION NOT VALID,
...
-- ALTER TABLE IF EXISTS public.review OWNER to murray5340; --This was auto generated when I used pgAdmin to creat the table. Is it needed?
COMMENT ON TABLE public.review IS 'final project table ';